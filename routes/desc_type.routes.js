...
router.post('/getlist_id', function (req, res) {
        desc_typeModel.find({Person_id:req.body.Person_id,delete_status : false}, function (err, StateList) {
...
router.get('/getlist', function (req, res) {
        desc_typeModel.find({delete_status : false}, function (err, Functiondetails) {
